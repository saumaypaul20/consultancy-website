...
?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 probootstrap-form">
            ...
            <p><a href="admin_dash.php">Dashboard </a> > Add/Edit FAQs</p>
    ...
    <a href="faq_update.php"><button  class="btn btn-primary">ADD</button></a>
      <a href="admin_dash.php"><button  class="btn ">BACK</button></a>
		...
		while ($rows1 = mysqli_fetch_array($result1)){
			...
			echo ' 
					...
					<a href="help.php" ><button class=" icon-eye2" style="font-size:20px; padding:10px;"></button></a>
                    <a href="delete.php?faq_id='.$rows1['id'].'" ><button class=" icon-bin2" style="font-size:20px; padding:10px;"></button></a></div>
				';
