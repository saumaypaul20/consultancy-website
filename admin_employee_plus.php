...
//get all inputs
 ...
 //validate all inputs if empty or case matches  
    ...
    if(empty($designation)){
        array_push($errors, "Designation is empty");
    }   
	...
	$q="INSERT INTO team (name, designation, speech, photo) VALUES ( '$first','$designation','$speech', '$Filename')";
	mysqli_query($conn,$q);
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 probootstrap-form">
            ...
            <p><a href="admin_dash.php">Control Panel </a> > Edit Team</p>
            ...
            <form action="" class="probootstrap-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="my-form-section">
                        ...
                        <p>Only <strong>JPEG</strong> Files are allowed. Files must less than<strong> 200KB</strong></p>
                    </div>

                    

                    <div class="form-group" style="text-align:center;">
                        <input  type="submit" class="btn btn-primary" name="add_team" value="ADD">
